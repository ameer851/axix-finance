...
const MOCK_MARKETING_MATERIALS = [
  {
    id: 1,
    title: 'CaraxFinance Banner - 728x90',
    description: 'Standard banner for websites and blogs',
    type: 'banner',
    format: 'image',
    thumbnailUrl: 'https://via.placeholder.com/728x90?text=CaraxFinance+Banner',
    downloadUrl: 'https://via.placeholder.com/728x90?text=CaraxFinance+Banner',
    shareUrl: 'https://caraxfinance.com/ref?id=fiona500&banner=1',
    embedCode: '<a href="https://caraxfinance.com/ref?id=fiona500&banner=1"><img src="https://via.placeholder.com/728x90?text=CaraxFinance+Banner" alt="CaraxFinance" /></a>',
    trackingLink: 'https://caraxfinance.com/ref?id=fiona500&banner=1',
    filename: 'carax-banner-728x90.jpg',
    featured: true,
    tags: ['banner', 'website']
  },
  {
    id: 2,
    title: 'CaraxFinance Banner - 300x250',
    description: 'Medium rectangle banner for websites',
    type: 'banner',
    format: 'image',
    thumbnailUrl: 'https://via.placeholder.com/300x250?text=CaraxFinance',
    downloadUrl: 'https://via.placeholder.com/300x250?text=CaraxFinance',
    shareUrl: 'https://caraxfinance.com/ref?id=fiona500&banner=2',
    embedCode: '<a href="https://caraxfinance.com/ref?id=fiona500&banner=2"><img src="https://via.placeholder.com/300x250?text=CaraxFinance" alt="CaraxFinance" /></a>',
    trackingLink: 'https://caraxfinance.com/ref?id=fiona500&banner=2',
    filename: 'carax-banner-300x250.jpg',
    featured: false,
    tags: ['banner', 'website']
  },
  {
    ...
    shareUrl: 'https://caraxfinance.com/ref?id=fiona500&template=welcome',
    embedCode: null,
    trackingLink: 'https://caraxfinance.com/ref?id=fiona500&template=welcome',
  ...
  },
  {
    ...
    shareUrl: 'https://caraxfinance.com/ref?id=fiona500&post=returns',
    embedCode: null,
    trackingLink: 'https://caraxfinance.com/ref?id=fiona500&post=returns',
  ...
  {
    id: 5,
    title: 'CaraxFinance Logo',
    description: 'High-resolution logo for print and digital use',
    type: 'image',
    format: 'png',
    thumbnailUrl: 'https://via.placeholder.com/500x500?text=CaraxFinance+Logo',
    downloadUrl: 'https://via.placeholder.com/500x500?text=CaraxFinance+Logo',
    shareUrl: 'https://caraxfinance.com/ref?id=fiona500&asset=logo',
    embedCode: null,
    trackingLink: 'https://caraxfinance.com/ref?id=fiona500&asset=logo',
    filename: 'carax-logo.png',
    featured: true,
    tags: ['logo', 'branding']
  },
  {
    ...
    description: 'Short promotional video explaining CaraxFinance benefits',
    type: 'video',
    format: 'mp4',
    ...
    shareUrl: 'https://caraxfinance.com/ref?id=fiona500&video=promo',
    ...
    trackingLink: 'https://caraxfinance.com/ref?id=fiona500&video=promo',
    filename: 'carax-promo-video.mp4',
    featured: true,

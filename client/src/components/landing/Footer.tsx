...
const Footer: React.FC = () => {
  ...
  return (
    <footer className="bg-white dark:bg-secondary">
      <div className="max-w-7xl mx-auto py-10 md:py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          <div className="space-y-6 md:space-y-8 xl:col-span-1">
            ...
            <div className="flex space-x-6">
              <a href="#" className="text-primary hover:text-primary/80" aria-label="Facebook" title="Facebook">
                <span className="sr-only">Facebook</span>
                <Facebook className="h-5 w-5 md:h-6 md:w-6" aria-hidden="true" />
              </a>
              <a href="#" className="text-primary hover:text-primary/80" aria-label="Twitter" title="Twitter">
                <span className="sr-only">Twitter</span>
                <Twitter className="h-5 w-5 md:h-6 md:w-6" aria-hidden="true" />
              </a>
              <a href="#" className="text-primary hover:text-primary/80" aria-label="Instagram" title="Instagram">
                <span className="sr-only">Instagram</span>
                <Instagram className="h-5 w-5 md:h-6 md:w-6" aria-hidden="true" />
              </a>
              <a href="#" className="text-primary hover:text-primary/80" aria-label="LinkedIn" title="LinkedIn">
                <span className="sr-only">LinkedIn</span>
                <Linkedin className="h-5 w-5 md:h-6 md:w-6" aria-hidden="true" />
              </a>
            </div>
          </div>
          <div className="mt-10 grid grid-cols-2 gap-5 sm:gap-8 xl:mt-0 xl:col-span-2">
            <div className="md:grid md:grid-cols-2 md:gap-8">
              {footerSections.slice(0, 2).map((section, index) => (
                <div key={index} className={index === 1 ? "mt-8 md:mt-0" : ""}>
                  ...
                  <ul className="mt-3 md:mt-4 space-y-3 md:space-y-4">
                    {section.links.map((link, linkIndex) => (
                      <li key={linkIndex}>
                        <a href={link.href} className="text-sm md:text-base text-gray-600 dark:text-gray-300 hover:text-primary dark:hover:text-primary">
                          {link.name}
                        </a>
                      </li>
                    ))}

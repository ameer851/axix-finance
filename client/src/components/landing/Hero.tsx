    ...
    <div className="relative bg-white dark:bg-secondary overflow-hidden">
      <div className="max-w-7xl mx-auto">
        <div className="relative z-10 pb-8 bg-white dark:bg-secondary sm:pb-16 md:pb-20 lg:max-w-2xl lg:w-full lg:pb-28 xl:pb-32">
          ...
          <main className="pt-10 sm:pt-16 md:pt-20 lg:pt-24 xl:pt-28 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="sm:text-center lg:text-left">
              ...
              <div className="mt-6 sm:mt-8 flex flex-col space-y-3 sm:space-y-0 sm:flex-row sm:justify-center lg:justify-start sm:space-x-4">
                ...
                <div>
                  <a href="#pricing">
                    <Button variant="outline" className="w-full flex items-center justify-center px-6 py-3 text-sm font-semibold rounded-xl border-2 border-primary text-primary hover:bg-primary hover:text-white transition-all duration-300 transform hover:scale-105 sm:px-8 sm:py-4 lg:px-10 lg:py-4 lg:text-base">
                      View Plans
                    </Button>
                  </a>
                </div>
              ...
              <div className="lg:hidden mt-8 grid grid-cols-2 gap-3 max-w-xs mx-auto sm:max-w-sm sm:gap-4">
                <div className="bg-primary/10 rounded-lg p-3 text-center sm:p-4">
                  <div className="text-xl font-bold text-primary sm:text-2xl">7.5%</div>
                  <div className="text-xs text-gray-600 dark:text-gray-300 sm:text-sm">Daily Returns</div>
                </div>
                <div className="bg-primary/10 rounded-lg p-3 text-center sm:p-4">
                  <div className="text-xl font-bold text-primary sm:text-2xl">10%</div>
                  <div className="text-xs text-gray-600 dark:text-gray-300 sm:text-sm">Referral Bonus</div>
                </div>
              </div>
            </div>
          </main>
        ...
        <div className="h-full w-full bg-gradient-to-br from-primary via-primary to-amber-700 flex items-center justify-center relative overflow-hidden">
          ...
          <div className="relative text-white text-center p-6 grid grid-cols-2 gap-6 max-w-lg mx-auto">
            <div className="flex flex-col items-center p-6 bg-white/15 rounded-2xl backdrop-blur-md border border-white/20 hover:bg-white/20 transition-all duration-300 transform hover:scale-105">
              ...
              <h3 className="text-lg xl:text-xl font-bold mb-2">Daily Returns</h3>
              <p className="text-sm xl:text-base opacity-90">Consistent profits</p>
            </div>
            <div className="flex flex-col items-center p-6 bg-white/15 rounded-2xl backdrop-blur-md border border-white/20 hover:bg-white/20 transition-all duration-300 transform hover:scale-105">
              <DollarSign className="w-12 h-12 xl:w-16 xl:h-16 mb-4" />
              <h3 className="text-lg xl:text-xl font-bold mb-2">Up to 7.5% Daily</h3>
              <p className="text-sm xl:text-base opacity-90">High returns</p>
            </div>
            <div className="flex flex-col items-center p-6 bg-white/15 rounded-2xl backdrop-blur-md border border-white/20 hover:bg-white/20 transition-all duration-300 transform hover:scale-105">
              <BarChart2 className="w-12 h-12 xl:w-16 xl:h-16 mb-4" />
              <h3 className="text-lg xl:text-xl font-bold mb-2">Multiple Plans</h3>
              <p className="text-sm xl:text-base opacity-90">Flexible options</p>
            </div>
            <div className="flex flex-col items-center p-6 bg-white/15 rounded-2xl backdrop-blur-md border border-white/20 hover:bg-white/20 transition-all duration-300 transform hover:scale-105">
              <Users className="w-12 h-12 xl:w-16 xl:h-16 mb-4" />
              <h3 className="text-lg xl:text-xl font-bold mb-2">10% Referrals</h3>

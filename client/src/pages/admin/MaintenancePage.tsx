  ...
  const recentMaintenances = [
    {
      ...
      duration: '2 hours',
      status: 'Completed',
      description: 'Applied critical security patches and updated SSL certificates',
    },
    {
      id: 2,
    ...
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-600 mt-1">Manage system maintenance and monitor health</p>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-2">
              ...
              <Select 
                ...
                onValueChange={(value) => 
                  setMaintenance(prev => ({ ...prev, maintenanceType: value }))
                }
              >
                <SelectTrigger>
            ...
            <div className="flex items-center justify-between">
              ...
              <Switch
                ...
                onCheckedChange={(checked) => 
                  setMaintenance(prev => ({ ...prev, allowAdminAccess: checked }))
                }
              />
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) => 
                  setMaintenance(prev => ({ ...prev, scheduledStart: e.target.value }))
                }
              />
            </div>
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) => 
                  setMaintenance(prev => ({ ...prev, scheduledEnd: e.target.value }))
                }
              />
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="space-y-2">
              ...
              <div className="w-full bg-gray-200 rounded-full h-2">
                <div className="bg-blue-500 h-2 rounded-full" style={{ width: systemStats.memoryUsage }}></div>
              </div>
            </div>
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                ...
                <span className="text-sm text-gray-600">{systemStats.databaseConnections}/100</span>
              </div>
              <div className="w-full bg-gray-200 rounded-full h-2">

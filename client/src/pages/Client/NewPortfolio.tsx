          ...
          {portfolioError ? (
            <Card>
              <CardContent className="text-center py-8">
                ...
                <h3 className="text-lg font-medium text-gray-900 mb-2">Unable to load portfolio data</h3>
                <p className="text-gray-500 mb-4">There was an error loading your portfolio information.</p>
                ...
                <CardContent>
                  {portfolioLoading ? (
                    ...
                    <div className="space-y-4">
                      {portfolio?.recentTransactions?.slice(0, 5).map((transaction: any, index: number) => (
            ...
            <CardContent>
              {portfolioLoading ? (
                ...
                <div className="text-center py-12">
                  ...
                  <Button onClick={() => window.location.href = '/client/deposit'}>
                    Start Investing
                  </Button>
                </div>
              ) : (
                      ...
                      <div className="flex justify-between items-start mb-3">
                        <div>
                          <h3 className="font-semibold text-lg">
                            {investment.planName || investment.name || 'Investment Plan'}
                          </h3>
                          <p className="text-sm text-gray-600">
                            Started: {formatDate(investment.startDate || investment.createdAt)}
                          </p>
                        </div>
                      ...
                      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                        ...
                        <div>
                          ...
                          <p className="font-semibold">
                            {formatCurrency(Number(investment.currentValue) || Number(investment.amount))}
                          </p>
                        </div>
                        <div>
                          <p className="text-xs text-gray-500">Profit/Loss</p>
                          <p className={`font-semibold ${getProfitColor(Number(investment.profit) || 0)}`}>
                            {formatCurrency(Number(investment.profit) || 0)}
                          </p>
                        </div>
                        <div>
                          <p className="text-xs text-gray-500">ROI</p>
                          <p className={`font-semibold ${getProfitColor(Number(investment.roi) || 0)}`}>
            ...
            <CardContent>
              {investmentsLoading ? (
                ...
                <div className="text-center py-12">
                  ...
                  <h3 className="text-lg font-medium text-gray-900 mb-2">No Investment History</h3>
                  <p className="text-gray-500">Your investment history will appear here.</p>
                </div>
              ) : (
                <div className="space-y-4">
                    ...
                    <div key={index} className="p-4 border border-gray-200 rounded-lg">
                      <div className="flex justify-between items-start mb-3">
                        <div>
                          ...
                          <p className="text-sm text-gray-600">
                            {formatDate(investment.createdAt || investment.date)}
                          </p>
                        </div>
                      ...
                      <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                        ...
                        <div>
                          ...
                          <p className="font-semibold text-green-600">
                            {investment.expectedReturn ? formatPercentage(Number(investment.expectedReturn)) : 'N/A'}
                          </p>
                        </div>
                      </div>
                    </div>

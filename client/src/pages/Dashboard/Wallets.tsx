    ...
    <div>
      ...
      <Card className="mb-6">
        <CardHeader>
          ...
          <CardDescription>Send funds to these addresses to make deposits</CardDescription>
        </CardHeader>
        <CardContent>
          <div className="space-y-6">
            <p className="text-sm text-gray-500 dark:text-gray-400">
              To make a deposit, send the amount you wish to invest to one of our cryptocurrency wallets below. 
              ...
              <div className="p-4 border rounded-md border-gray-200 dark:border-gray-700">
                ...
                <div className="flex items-center p-2 bg-gray-100 dark:bg-neutral-800 rounded-md">
                  ...
                  <Button 
                    ...
                    size="icon"
                    onClick={() => {
                      navigator.clipboard.writeText("bc1qs0ftgvepn2e6an0cam5ng8wz8g8exsnmupwu58");
                      setCopiedText("bc1qs0ftgvepn2e6an0cam5ng8wz8g8exsnmupwu58");
                      setTimeout(() => setCopiedText(null), 2000);
                    }}
                    className="ml-2 hover:bg-gray-200 dark:hover:bg-neutral-700"
                  >
                    {copiedText === "bc1qs0ftgvepn2e6an0cam5ng8wz8g8exsnmupwu58" ? (
                      <Check className="h-4 w-4 text-green-500" />
                    ) : (
                      <Copy className="h-4 w-4" />
                    )}
              ...
              <div className="p-4 border rounded-md border-gray-200 dark:border-gray-700">
                ...
                <div className="flex items-center p-2 bg-gray-100 dark:bg-neutral-800 rounded-md">
                  ...
                  <Button 
                    ...
                    size="icon"
                    onClick={() => {
                      navigator.clipboard.writeText("qpnej2mh5wh68qhqps8hych9mecpmw3rvgkznv0v0g");
                      setCopiedText("qpnej2mh5wh68qhqps8hych9mecpmw3rvgkznv0v0g");
                      setTimeout(() => setCopiedText(null), 2000);
                    }}
                    className="ml-2 hover:bg-gray-200 dark:hover:bg-neutral-700"
                  >
                    {copiedText === "qpnej2mh5wh68qhqps8hych9mecpmw3rvgkznv0v0g" ? (
                      <Check className="h-4 w-4 text-green-500" />
                    ) : (
                      <Copy className="h-4 w-4" />
                    )}
              ...
              <div className="p-4 border rounded-md border-gray-200 dark:border-gray-700">
                ...
                <div className="flex items-center p-2 bg-gray-100 dark:bg-neutral-800 rounded-md">
                  ...
                  <Button 
                    ...
                    size="icon"
                    onClick={() => {
                      navigator.clipboard.writeText("0xe5fd698fEE63ACf879d6fd127a2b90781256Bb32");
                      setCopiedText("0xe5fd698fEE63ACf879d6fd127a2b90781256Bb32");
                      setTimeout(() => setCopiedText(null), 2000);
                    }}
                    className="ml-2 hover:bg-gray-200 dark:hover:bg-neutral-700"
                  >
                    {copiedText === "0xe5fd698fEE63ACf879d6fd127a2b90781256Bb32" ? (
                      <Check className="h-4 w-4 text-green-500" />
                    ) : (
                      <Copy className="h-4 w-4" />
                    )}
              ...
              <div className="p-4 border rounded-md border-gray-200 dark:border-gray-700">
                ...
                <div className="flex items-center p-2 bg-gray-100 dark:bg-neutral-800 rounded-md">
                  ...
                  <Button 
                    ...
                    size="icon"
                    onClick={() => {
                      navigator.clipboard.writeText("THpFyXdC93QvnM8DJUeLmEVjq2hsFpULWb");
              ...
              <div className="p-4 border rounded-md border-gray-200 dark:border-gray-700 md:col-span-2">
                ...
                <div className="flex items-center p-2 bg-gray-100 dark:bg-neutral-800 rounded-md">
                  ...
                  <Button 
                    ...
                    onClick={() => {
                      navigator.clipboard.writeText("0xe5fd698fEE63ACf879d6fd127a2b90781256Bb32");
                      setCopiedText("0xe5fd698fEE63ACf879d6fd127a2b90781256Bb32_bnb");
                      setTimeout(() => setCopiedText(null), 2000);
                    }}
                    className="ml-2 hover:bg-gray-200 dark:hover:bg-neutral-700"
                  >
                    {copiedText === "0xe5fd698fEE63ACf879d6fd127a2b90781256Bb32_bnb" ? (
                      <Check className="h-4 w-4 text-green-500" />
                    ) : (
                      <Copy className="h-4 w-4" />
                    )}

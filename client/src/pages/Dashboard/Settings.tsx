          ...
          <div className="grid gap-6 grid-cols-1 md:grid-cols-2">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Details about your account verification</CardDescription>
              </CardHeader>
              <CardContent>
              ...
              <CardContent>
                <div className="space-y-4">
                  <p className="text-sm text-gray-500 dark:text-gray-400">
                    Share your referral link and earn 10% commission on all investments made by your referrals.
                  </p>
              ...
              <CardContent>
                <div className="space-y-4">
                  <div className="border-b pb-2">
                    ...
                    <p className="text-xs text-gray-500 mt-1">Successful login from Paris, France</p>
                  </div>
                  <div className="border-b pb-2">
                    <div className="flex justify-between items-center">
                      <div className="flex items-center">
                        <Mail className="h-4 w-4 text-gray-500 mr-2" />
                        <span className="text-sm font-medium">Email Changed</span>
                      </div>
                      <span className="text-xs text-gray-500">Yesterday</span>
                    </div>
                    <p className="text-xs text-gray-500 mt-1">Your email address was updated</p>
                  </div>
                </div>
              </CardContent>
              <CardFooter>
                <Button variant="link" className="px-0">View Full Security Log</Button>
              </CardFooter>
            </Card>
          </div>
        </TabsContent>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div className="space-y-2">
                  <Label htmlFor="withdrawal-address">Default Withdrawal Address</Label>
                  <Input id="withdrawal-address" placeholder="Enter your withdrawal address" />
                </div>
              ...
              <CardContent className="space-y-4">
                <div className="flex items-center justify-between">
                  <div className="space-y-0.5">
                    ...
                    <p className="text-xs text-gray-500">Notifications about your transactions</p>
                  </div>
                ...
                <div className="flex items-center justify-between">
                  <div className="space-y-0.5">
                    ...
                    <p className="text-xs text-gray-500">News, updates, and promotions</p>
                  </div>
                  ...
                  <div className="border-b pb-2">
                    <div className="flex justify-between items-center">
                      <div>
                        ...
                        <p className="text-xs text-gray-500">Paris, France - Chrome on Windows</p>
                      </div>

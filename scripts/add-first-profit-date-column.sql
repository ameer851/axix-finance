-- Complete database setup for 24-hour profit system
-- This script creates the investments tables and adds the first_profit_date column
...
-- Create investment_returns table if it doesn't exist
...
-- Add first_profit_date column to investments table for 24-hour profit system
ALTER TABLE investments
ADD COLUMN IF NOT EXISTS first_profit_date TIMESTAMP WITH TIME ZONE;

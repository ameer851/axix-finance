...
async function verifyDatabaseSetup() {
  try {
    ...
    console.log(
      "1. Run the SQL migration script: node scripts/add-first-profit-date-column.js"
    );
    ...
    console.log("\n🎯 Next Steps:");
    console.log(
      "✅ Database setup complete - you can now test the 24-hour profit system!"
    );
    console.log(
      "✅ Run: node scripts/test-24-hour-profit-system.js (optional)"
    );
  } catch (error) {
